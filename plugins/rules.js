...
`.trim(), 'Kebijakan ©2022 By RiellCuyy', '⋮☰ Menu', '.menu', 'Owner', '.nowner', 'Donasi', '.donasi', m, {
    quoted: m,
    contextInfo: {
        externalAdReply: {
            ...
            mediaType: 2,
          thumbnail: await (await fetch('https://telegra.ph/file/0e4fb9bfb49f985ef053e.jpg')).buffer(),
